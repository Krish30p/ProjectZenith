        ...
        <div className="relative w-full h-full flex rounded-[2px] shadow-[0_30px_60px_rgba(0,0,0,0.8),_0_0_120px_rgba(0,229,255,0.05)] border border-white/10 bg-[#070b14]">
          ...
          <div className="flex w-full h-full relative z-10 bg-[#09101d] rounded overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 w-16 md:w-24 z-30 flex items-center justify-center">
              {spread === 1 && (
                <button onClick={() => setSpread(2)} className="group flex flex-col items-center justify-center py-6 px-3 bg-white/5 hover:bg-white/10 transition-all border border-white/10 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.05)] backdrop-blur-sm">
                  <span className="text-[10px] font-mono text-slate-400 uppercase tracking-[0.2em] [writing-mode:vertical-lr] rotate-180 mb-3 group-hover:text-[#00E5FF] transition-colors">Turn Page</span>
                  <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#00E5FF] group-hover:translate-x-1 transition-all" />
                </button>
              )}
            </div>
            <div className="absolute inset-y-0 left-0 w-16 md:w-24 z-30 flex items-center justify-center">
              {spread === 2 && (
                <button onClick={() => setSpread(1)} className="group flex flex-col items-center justify-center py-6 px-3 bg-white/5 hover:bg-white/10 transition-all border border-white/10 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.05)] backdrop-blur-sm">
                  <ChevronLeft className="w-4 h-4 text-slate-400 group-hover:text-[#00E5FF] group-hover:-translate-x-1 transition-all mb-3" />
                  <span className="text-[10px] font-mono text-slate-400 uppercase tracking-[0.2em] [writing-mode:vertical-lr] rotate-180 group-hover:text-[#00E5FF] transition-colors">Previous</span>
                </button>
              )}
            </div>
